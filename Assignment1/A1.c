...
{ // Function to create new nodes with dynamic memory allocation
    NODEPTR p;
...
{ // creating a structure queue whose elements are pointers of the data type NODEPTRS, i.e, pointers to nodepointers of nodes
    NODEPTR front, rear;
} QUEUE;
